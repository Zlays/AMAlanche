...
// @Failure 500 {object} dto.ErrorResponse "Internal server error"
// @Router /user/{userId}/channel/{channelId}  [get]
...
// @Produce json
// @Param userId path int true "ID of the user"
// @Success 200 {object} dto.ChannelGetAllResponse "Channels retrieved successfully"
// @Failure 400 {object} dto.ErrorResponse "Bad request"
// @Failure 403 {object} dto.ErrorResponse "Forbidden access"
// @Router /user/{userId}/channel/all  [get]
func (uc *UserChannelController) GetAll() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		response := &dto.ChannelGetAllResponse{}
...
// @Produce json
// @Param userId path int true "ID of the user"
// @Success 200 {object} dto.ChannelGetAllResponse "Owned channels retrieved successfully"
// @Failure 400 {object} dto.ErrorResponse "Bad request"
// @Failure 403 {object} dto.ErrorResponse "Forbidden access"
// @Failure 500 {object} dto.ErrorResponse "Internal server error"
// @Router /user/{userId}/owned [get]
...
// @Produce json
// @Param userId path int true "ID of the user"
// @Success 200 {object} dto.ChannelGetAllResponse "Visible channels retrieved successfully"
// @Failure 400 {object} dto.ErrorResponse "Bad request"
// @Failure 403 {object} dto.ErrorResponse "Forbidden access"
// @Router /user/{userId}/visible [get]
func (uc *UserChannelController) GetAllVisible() gin.HandlerFunc {
	return func(c *gin.Context) {
		userIdStr := c.Param("userId")
